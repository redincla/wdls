...
samtools view /users/credin/scratch/WGS/data_and_refs/data/Raw_FQ/CoPrAc/2101/Phasing/${sample_ID}.cram "chr11:46000000-49000000" -C \
    -T /home/credin/refs/references/hg38/Homo_sapiens_assembly38.fasta > /users/credin/scratch/WGS/data_and_refs/data/Raw_FQ/CoPrAc/2101/Phasing/${sample_ID}.MYBPCR3region.cram
samtools index /users/credin/scratch/WGS/data_and_refs/data/Raw_FQ/CoPrAc/2101/Phasing/${sample_ID}.MYBPCR3region.cram
