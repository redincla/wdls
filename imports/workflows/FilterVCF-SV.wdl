...
command <<<
     ...
     VariantsToTable \
        ...
        -F ClinVar_Sign -F CLINSIG -F ClinVar_Sign_Conflict -F ClinVar_RevStatus -F ClinVar_Disease_name -F ClinGen_Disease_name -F ClinGen_MOI -F ClinGen_Classification -F MIM_Disease -F MIM_Disease_name -F MIM_gene -F DDD_mutation_consequence -F DDD_MOI -F DDD_Classification -F MEDP_MOI -F MEDP_Confidence -F n.PLP.ClinVar -F n.PLP.LoF.ClinVar -F n.PLP.mis.ClinVar -F IFNpathway_gene_name -F IFNpathway_gene_id \
        ...
        -F DEOGEN2_pred -F BayesDel_addAF_pred -F BayesDel_noAF_pred -F ClinPred_pred -F LIST-S2_pred -F CADD_raw -F CADD_phred -F DANN_score -F fathmm-MKL_coding_pred -F fathmm-XF_coding_pred -F Eigen-raw_coding -F Eigen-phred_coding \
