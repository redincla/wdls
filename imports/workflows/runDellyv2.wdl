...
import "/scratch/beegfs/PRTNR/CHUV/chuv_medp/WGS/wdls/imports/tasks/delly-tasksv2.wdl" as Tasks
...
#    File full_map # col 1: sample ID , col 2: input bam/cram , col3: input bam/cram index
    ...
    String cohort_name
      ...
      input:
        ...
        input_bcfs_index = GenotypeBCF.genotyped_bcf_index,
        cohort_name = cohort_name
      }
  ...
  output {
    ...
    File index = FilterGenotypedBCF.index
  }
}