...
java -Dconfig.file=/home/credin/.cromwell.conf_new -jar /software/Utility/cromwell/47/bin/cromwell-47.jar  run /home/credin/scratch/WGS/wdls/imports/workflows/runDelly-sample.wdl -i /home/credin/scratch/WGS/wdls/imports/config-files/runDelly.inputs.json -o /home/credin/scratch/WGS/wdls/imports/config-files/runDelly.options.json