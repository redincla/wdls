...
File sample_list
Array[File] input_vcf_ALL
Array[File] input_vcf_ALL_index
Array[File] input_vcf_PASS
Array[File] input_vcf_PASS_index
File ref_fasta
File ref_index
File ref_dict
File GATK
...
#      input:
#        input_vcf = input_vcf_PASS[idx],
#        input_vcf_index = input_vcf_PASS_index[idx],
...
#  Array[File] HighImpactPASSONLY_input_vcfs_idx = GetHighImpactPASSONLY.output_vcf_index

#  Array[File] ModImpactNonMisPASSONLY_input_vcfs = GetModImpactNonMisPASSONLY.output_vcf
#  Array[File] ModImpactNonMisPASSONLY_input_vcfs_idx = GetModImpactNonMisPASSONLY.output_vcf_index

#  Array[File] ModImpactMissensePASSONLY_input_vcfs = GetModImpactMissensePASSONLY.output_vcf
#  Array[File] ModImpactMissensePASSONLY_input_vcfs_idx = GetModImpactMissensePASSONLY.output_vcf_index

  Array[File] LowImpactSynPASSONLY_input_vcfs = GetLowImpactSynPASSONLY.output_vcf
  Array[File] LowImpactSynPASSONLY_input_vcfs_idx = GetLowImpactSynPASSONLY.output_vcf_index


#  call GatherVcfs as GatherHighImpactPASSONLY {
#    input:
#      GATK = GATK,
#      tabix = tabix,
#      input_vcfs = HighImpactPASSONLY_input_vcfs,
#      input_vcfs_index = HighImpactPASSONLY_input_vcfs_idx,
#      output_vcf_name = vcf_prefix + ".HighImpactPASSONLY.vcf.gz"
#  }

#  call GatherVcfs as GatherModImpactNonMisPASSONLY {
#    input:
#      GATK = GATK,
#      tabix = tabix,
#      input_vcfs = ModImpactNonMisPASSONLY_input_vcfs,
#      input_vcfs_index = ModImpactNonMisPASSONLY_input_vcfs_idx,
#      output_vcf_name = vcf_prefix + ".ModImpactNonMisPASSONLY.vcf.gz"
#  }

#  call GatherVcfs as GatherModImpactMissensePASSONLY {
#    input:
#      GATK = GATK,
#      tabix = tabix,
#      input_vcfs = ModImpactMissensePASSONLY_input_vcfs,
#      input_vcfs_index = ModImpactMissensePASSONLY_input_vcfs_idx,
#      output_vcf_name = vcf_prefix + ".ModImpactMissensePASSONLY.vcf.gz"
#  }

 call GatherVcfs as GatherLowImpactSynPASSONLY {
    input:
      GATK = GATK,
      tabix = tabix,
      input_vcfs = LowImpactSynPASSONLY_input_vcfs,
      input_vcfs_index = LowImpactSynPASSONLY_input_vcfs_idx,
...
############
### 12- Count carriers of qualifying variants
############
...
task CountCarriers {
  ...
  String sample_list_arg = if defined(sample_list) then "--samplefile ~{sample_list}" else ""
