...
if [ $# -eq 2 ]; then
 ...
 echo "Usage:"
 echo "sbatch submit_annovar.sh [input_file] [options_file] "
 echo "input_file: full path to inputs json file"
 echo "options_file: full path to options json file"
 exit 1
fi

java -Dconfig.file=/home/credin/.cromwell.conf_new -jar /software/Utility/cromwell/47/bin/cromwell-47.jar run /home/credin/scratch/WGS/wdls/imports/workflows/annotateVCF.wdl -i ${input_file} -o ${options_file} 
